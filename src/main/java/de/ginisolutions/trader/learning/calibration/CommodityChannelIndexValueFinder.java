...
public class CommodityChannelIndexValueFinder {
    ...
    public ProfitCCI run(BarSeries barSeries) {
        ...
        final ProfitCCI[] profit2RelativeStrengthIndices = convertStreamThreadLocal(barSeries, parameterCommodityChannelIndices);
     ...
     * @return
     */
    private static ProfitCCI[] convertStreamThreadLocal(final BarSeries barSeries, final ParameterCommodityChannelIndex[] parameterCommodityChannelIndexStream) {
        ...
        return Arrays.stream(parameterCommodityChannelIndexStream)
                ...
                .map(parameterCommodityChannelIndex -> {
                    ...
                    return new ProfitCCI(profit, parameterCommodityChannelIndex);
