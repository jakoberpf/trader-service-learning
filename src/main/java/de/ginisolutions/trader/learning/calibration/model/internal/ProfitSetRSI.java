...
public class ProfitSetRSI implements ProfitSet {
    ...
    public ProfitSetRSI(@NotNull STRATEGY strategy, @NotNull MARKET market, @NotNull SYMBOL symbol, @NotNull INTERVAL interval, @NotNull double profit, @NotBlank ParameterRSI parameter) {
    ...
    public void setParameter(StrategyParameter parameter) {
        this.parameter = (ParameterRSI) parameter;
    }
